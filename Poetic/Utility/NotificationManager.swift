...
class NotificationManager: ObservableObject {
    private let notifications: [NotificationObject] = [
        NotificationObject(author: "Mark Twain", quote: "Two roads diverged in a yellow wood, And sorry I could not travel both..."),
        NotificationObject(author: "Walt Whitman", quote: "Resist much, obey little..."),
        NotificationObject(author: "William Shakespeare", quote: "I like this place and could willingly waste my time in it..."),
        NotificationObject(author: "Emily Dickinson", quote: "If I read a book and it makes my whole body so cold no fire can warm me..."),
        NotificationObject(author: "William Wordsworth", quote: "I wandered lonely as a cloud That floats on high o'er vales and hills..."),
        NotificationObject(author: "Charlotte Bronte", quote: "So dark as sages say; Oft a little morning rain..."),
        NotificationObject(author: "Edgar Allan Poe", quote: "Once upon a midnight dreary, while I pondered, weak and weary...")
    ]
    ...
    func addNotification() {
        ...
        let fridayRequest = UNNotificationRequest(identifier: UUID().uuidString, content: content, trigger: fridayTrigger)
